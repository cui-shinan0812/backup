    ...
    <div class="container">
        ...
        <div class="home-wrap">
            ...
            <div id="home-slick">
                ...
                <!-- banner -->
                <div class="banner banner-1">
                    <img src="{!! asset('images/product/banner02.jpg') !!}" alt="">
                ...
                <!-- banner -->
                <div class="banner banner-1">
                    <img src="{!! asset('images/product/banner03.jpg') !!}" alt="">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="banner banner-2">
                    <img src="{!! asset('images/product/banner14.jpg') !!}" alt="">
                    <div class="banner-caption">
                    ...
                    <div id="product-slick-1" class="product-slick">
                        ...
                        <div class="product product-single">
                            <div class="product-thumb">
                                ...
                                <img src="{!! asset('images/product/product01.jpg') !!}" alt="">
                            </div>
                            <div class="product-body">
                                ...
                                <div class="product-btns">
                                    ...
                                    <button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> {{ trans('index.inquiry') }}</button>
                                </div>
                            </div>
                        </div>
                        <!-- /Product Single -->
